...
public class Boggle_Game {
	...
	private void search(List<List<int[]>> paths, char[][] board, int x, int y, Trie trie, boolean[][] visited,
			List<int[]> curPath) {
	...
	private void searchWords(List<String> res, List<String> curWords, List<List<int[]>> paths, int start,
